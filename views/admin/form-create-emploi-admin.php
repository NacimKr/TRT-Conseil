...
<form action="offres_emploi" class="container mt-5" style="width:700px;" method="POST">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="duration" id="duration" style="background:#dcdcdc" required>
    </div>

    <div class="mb-3">
        <label for="debut" class="form-label">Horaires Début</label>
        <input type="time" class="form-control mb-2" name="debut" id="debut" style="background:#dcdcdc" required>
        <label for="fin" class="form-label ">Horaires Fin</label>
        <input type="time" class="form-control" name="fin" id="fin"  style="background:#dcdcdc" required>
    </div>

    <div class="mb-3">
        <label for="salary" class="form-label">Salaire</label>
        <input type="text" class="form-control" name="salary" id="salary" style="background:#dcdcdc" placeholder="€" required>
    </div>
