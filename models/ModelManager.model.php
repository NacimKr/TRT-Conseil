...
class ModelManager extends MainModel{
    ...
    public function createNewOffresEmploi($poste, $duree, $description, $salaire){
        $req = "INSERT INTO emplois (POSTE, Durée, Description, Salaire) VALUES 
        (:poste, :duree, :description, :salaire);";
